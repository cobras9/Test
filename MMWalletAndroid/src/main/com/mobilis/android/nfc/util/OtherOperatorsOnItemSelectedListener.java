 ...
 */
public class OtherOperatorsOnItemSelectedListener implements AdapterView.OnItemSelectedListener {

    Activity mActivity;

    public OtherOperatorsOnItemSelectedListener(Activity activity){
        mActivity = activity;
    }
    ...
    public void onItemSelected(AdapterView<?> parent, View view, int pos,long id) {
        if(TransferCode.bankCodes.size() == 0)
            return;
        final EditText amount = (EditText) mActivity.findViewById(R.id.Fragment_OtherOperators_EditText_Amount);
