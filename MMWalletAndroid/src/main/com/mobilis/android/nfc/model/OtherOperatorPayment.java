...
public class OtherOperatorPayment extends AbstractModel implements Financial {

    private String phoneNumber;
    private String destinationCode;
    private Context mContext;

	public OtherOperatorPayment(Activity activity) {
...
//        buffer.append(getFullParamString(getResString(R.string.REQ_CUST_SEARCH_DATA), getCustomerSearchData(), false));
	...
	public void verifyPostTaskResults() {
        Intent intent = new Intent(INTENT.OTHER_OPERATOR.toString());
